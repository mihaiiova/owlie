...
/**
 * Opt-in live test configuration. These tests make real network calls to
 * YouTube/DeepSeek and require credentials + `OWLIE_LIVE_TESTS=1`. They are
 * excluded from the default suite and from CI. Run with:
 *
